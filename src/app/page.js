...
useEffect(() => {
  ...
  // Set the initial name immediately
  setNewName(titles[0]);
...
export const MotionDock = ({ isTop }) => {
  return (
    <motion.div
      key={isTop ? "from-bottom" : "from-top"} // 🔑 This forces re-animation on state change
      initial={{ y: isTop ? "-50vh" : "30vh", opacity: 0 }} // 🔄 Conditional entry point
      animate={{ y: isTop ? "-80px" : "0vh", opacity: 1 }}   // 🎯 Destination
