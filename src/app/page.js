...
export const Seperator = () => {
  return (
    <div className="bg-[#999999] mx-2 min-h-7 max-h-7 min-w-0.5 max-w-0.5" />
  )
}
...
const Icons = {
  ...
  gitHub: (props) => (
    <svg className="p-[1px]" viewBox="0 0 438.549 438.549" width="200" height="200">
      <path
        fill="#333333"
  ...
  profile: (props) => (
    <svg className="p-0.5" viewBox="-32 0 512 512" width="50" height="50">
      <path
        fill="#333333"
