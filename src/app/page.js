  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center font-[family-name:var(--font-geist-sans)]">
      <div className="flex flex-col items-center">
        ...
        <span className="inline-block text-[200px] text-black leading-none">
          ASWIN P<span className="text-red-500">.</span>
        </span>
        <span>
          <TypingAnimation className="inline-block text-[50px] tracking-wide text-black leading-none">{newName}</TypingAnimation>
        </span>
      </div>
    </div>
...
const Icons = {
  ...
  gitHub: (props) => (
    <svg className="p-[1px]" viewBox="0 0 438.549 438.549" width="50" height="50">
      <path
        fill="#333333"
...
//     viewBox="10 0 80 100"
//   >
//     <path d="M26.3,22.7c-4.5,0-8.2,3.5-8.2,7.8v44.3c0,4.3,3.7,7.8,8.2,7.8h43.6c4.5,0,8.2-3.5,8.2-7.8V30.5 c0-4.3-3.7-7.8-8.2-7.8H26.3z M37.2,40.9c0,1.4-1.2,2.6-2.7,2.6h-2.7c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h2.7 c1.5,0,2.7,1.2,2.7,2.6V40.9z M67.2,40.9c0,1.4-1.2,2.6-2.7,2.6H45.4c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h19.1 c1.5,0,2.7,1.2,2.7,2.6V40.9z M37.2,54c0,1.4-1.2,2.6-2.7,2.6h-2.7c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h2.7 c1.5,0,2.7,1.2,2.7,2.6V54z M62.2,54c0,1.4-1.2,2.6-2.7,2.6H45.4c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h14.1 c1.5,0,2.7,1.2,2.7,2.6V54z M37.2,67c0,1.4-1.2,2.6-2.7,2.6h-2.7c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h2.7 c1.5,0,2.7,1.2,2.7,2.6V67z M67.2,67c0,1.4-1.2,2.6-2.7,2.6H45.4c-1.5,0-2.7-1.2-2.7-2.6v-2.6c0-1.4,1.2-2.6,2.7-2.6h19.1 c1.5,0,2.7,1.2,2.7,2.6V67z" />
//   </svg>
