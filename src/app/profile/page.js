        ...
        <div className="h-screen w-screen flex flex-col font-[family-name:var(--font-geist-sans)] overflow-x-hidden">
            ...
            <div className="flex flex-col items-center mt-32 gap-10 text-3xl">
                <motion.div
                    ...
                    <div>
                        About
                        <div className="w-52 h-52 rounded-full bg-[#dd3333] border-4 border-white shadow-lg flex items-center justify-center relative overflow-hidden">
                            <Image
                                src="/pfp.png"
                ...
                <motion.div
                    ...
                    {[1, 2, 3, 4].map((_, i) => (
                        <motion.div
                            key={i}
                            className="bg-[#dddddd33] border-2 rounded-3xl p-10 w-[700px]"
                            variants={reveal}
                            initial="hidden"
                            animate="visible"
